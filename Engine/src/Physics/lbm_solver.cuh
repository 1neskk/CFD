...
public:
    ...
    __host__ __device__ cuda_buffer<cuda_math::vec4>& get_velocity() { return d_u; }
    __host__ __device__ cuda_buffer<unsigned char>& get_solid_mask() { return d_solid; }
...
private:
    ...
    cuda_buffer<cuda_math::vec4> d_u;     // Macroscopic velocity (x, y, z, padding)
